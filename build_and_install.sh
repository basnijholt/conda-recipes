...
conda build metis; conda build scotch; conda build lapack; conda build mumps_seq; conda build tinyarray --python 3.5; conda build tinyarray --python 3.4; conda build tinyarray --python 2.7; conda build kwant --python 3.5; conda build kwant --python 3.4; conda build kwant --python 2.7;
